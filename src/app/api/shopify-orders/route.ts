...
// Use the Shopify-provided webhook secret
const WEBHOOK_SECRET = process.env.SHOPIFY_WEBHOOK_SECRET || '806a6f7c6c31e5e5b2e09971da57428f37798b8b2254426a142cbb433baa923c';
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log(`Webhook received: ${topic} from ${clientIp}`);
    ...
    if (!verifyWebhook(body, signature)) {
      ...
      const hmac = createHmac('sha256', WEBHOOK_SECRET);
      hmac.update(body, 'utf8');
      console.log('Expected HMAC:', hmac.digest('base64'));
